...
SECRET_KEY = os.environ.get('llave') #'django-insecure-w+wdkgexood@jt1pu$%yz>'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'admincred/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cuentas',
        'USER': 'admin',
        'PASSWORD': os.environ.get('pwdbd'), #'z49lhCLP6STJgNBy',
        #
        'HOST': '127.0.0.1',
        'PORT': '3306',
    }
